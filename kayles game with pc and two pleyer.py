...
while w==1:
    ...
    for s in range(size):
        L1.append(s)
        L2.append(z)
    print('you are want play with your pc or friend')
    print('enter pc or friend')
    e=input()
    while True:
        if e!='friend' and e!='pc':
            print('you should enter friend or pc')
            e=input('enter pc or friend\n')
        if e=='friend':
            print(L1)
            for i in  L1:
            ...
            print(L1)
            while True:
                print("p:are you want enter one number or two")
                a=int(input())
                while True:
                    if a!=1 and a!=2:
                        print('you should enter 1 or 2')
